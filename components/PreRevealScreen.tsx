    ...
    <div className="min-h-screen flex items-center justify-center px-5 sm:px-8 py-16">
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mb-7 w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400/30 to-[var(--color-brand-500)]/20 border border-emerald-400/40 flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(225,29,42,0.4)]"
        >
        ...
        <motion.button
          ...
          className="
            ...
            text-white
            px-6 py-5
            shadow-[0_20px_50px_-15px_rgba(225,29,42,0.6)]
            hover:shadow-[0_25px_60px_-10px_rgba(225,29,42,0.7)]
