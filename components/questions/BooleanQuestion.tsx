        ...
        return (
          <motion.button
            ...
            className={`
              ...
              ${
                selected
                  ? "bg-gradient-to-br from-[var(--color-brand-600)]/30 to-[var(--color-brand-800)]/30 border border-[var(--color-brand-400)]/60 text-white shadow-[0_0_0_3px_rgba(225,29,42,0.12)]"
